...
export const UpcomingEventUnWind = (props) => {
  return (
    <div>
      <table cellPadding="0" cellSpacing="0" border="0" width="88%" style={{width: '88%', minWidth: '88%', maxWidth: '88%', background: '#337ab7'}}>
        <tbody>
          <tr>
            ...
            <td align="left" valign="top">
              ...
              <a href={props.eventLinkTo} style={{display: 'block', width: '100%', textDecoration: 'none'}}>
                ...
                <font face="'Work Sans', sans-serif" color="#ffffff" style={{fontSize: 24, lineHeight: 1.2, fontWeight: 600, textDecoration: 'none'}}>
                  <span style={{fontFamily: "'Work Sans', sans-serif", color: "#ffffff", fontSize: 24, lineHeight: 1.2, fontWeight: 600, textDecoration: 'none'}}>
                    {props.eventTitle}
                  </span>
                </font>
                ...
                <font face="'Work Sans', sans-serif" color="#ffffff" style={{fontSize: 16, lineHeight: 1.2, fontWeight: 600, textDecoration: 'none'}}>
                  <span style={{fontFamily: "'Work Sans', sans-serif", color: "#ffffff", fontSize: 16, lineHeight: 1.2, fontWeight: 600, textDecoration: 'none'}}>
