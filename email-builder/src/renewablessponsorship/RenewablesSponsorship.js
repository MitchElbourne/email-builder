    ...
    return (
      <div className="renewables-unwind">
        ...
        <EmailContainer>
          ...
          <ImageBlock
            imgSrc="https://www.energeiaworks.com/email/2019-04/20190430-UnWind-Minneapolis_Email.jpg"
            imgAlt="Renewables UnWind Minneapolis Banner"
            paddingTop={24}
            paddingBottom={2}
          />
          ...
          <TitleBlock
            text={"Sponsor our Minneapolis UnWind!"}
            fontSize={32}
            paddingTop={16}
            paddingBottom={8}
          />
          ...
          <TextBlock
            text={["Join our current sponsors Antenna, EnergeiaWorks and MWSE and help split the bill at this MidWest Solar Expo after event."]}
            fontSize={16}
          />
          <TextBlock
